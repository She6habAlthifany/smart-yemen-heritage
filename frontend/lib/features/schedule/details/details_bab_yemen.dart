...
class DetailsBabYemen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // نستخدم id ثابت حتى تحفظ المفضلة بشكل صحيح
    const placeId = 'bab_yemen';
    const placeTitle = 'باب اليمن';
    const placeImage = 'assets/images/bab_yemen.jpg';
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: CircleAvatar(
                    backgroundColor: Colors.black54,
                    child: IconButton(
                      // أيقونة القلب تعتمد على حالة المفضلة في FavoritesManager
                      icon: Icon(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          IconButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const ARViewScreen()));
                            },
